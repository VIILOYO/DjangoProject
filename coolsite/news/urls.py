...
from .views import CategoryDetail, create_comment, CreateNews, NewsDetail, NewsList, contacts


urlpatterns = [
    path('', NewsList.as_view(), name='HomePage'),
    path('contacts', contacts, name='contacts'),
    path('news/<slug:news_slug>/add_comment', create_comment, name='CreateComment'),
